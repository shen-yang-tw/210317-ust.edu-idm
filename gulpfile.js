...
const uk = true, fa = true, tw = true, bs = false, bs3 = false, jq = false, keepcss = false, onlyscript =true
...
var paths = {
  ...
  colorscss: ['color-nthu.css', 'color-ncu.css'],
  vendors: {
    ...
    keepcss: ['src/vendors/*.css'],
    keepjs: ['src/vendors/*.js'],
    // bodyjs: ['src/js/*.js'],
  ...
  src: {
    ...
    scss: 'src/scss/*.scss',
    keepjs: onlyscript ? '!src/js/script.js' : ['!src/js/script.js', '!src/js/-bak*.js', '!src/js/-old*.js', '!src/js/-i*.js'],
...
gulp.task('keepcss', function() {
  // return gulp.src([], {allowEmpty: true})
  return gulp.src(paths.vendors.keepcss)
    // .pipe(gulpif(keepcss, gulp.dest(paths.src.root + paths.dist.css)))
    .pipe(gulpif(keepcss, gulp.dest(paths.dist.root + paths.dist.css)))
})
gulp.task('facss', function() {
  return gulp.src(paths.vendors.facss)
...
gulp.task('fafonts', function() {
  return gulp.src(paths.vendors.fafonts)
...
gulp.task('bs3js', function() {
  return gulp.src(paths.vendors.bs3js)
...
gulp.task('bs3css', function() {
  return gulp.src(paths.vendors.bs3css)
...
gulp.task('bs3fonts', function() {
  return gulp.src(paths.vendors.bs3fonts)
...
gulp.task('templates', async function() {
  var templateData = {
      ...
      // jqueryBody: 'true',
      // bootstrapBody: 'true',
      // bodyFocus: 'true' //Add the class 'focus' to <body> for AA,
      // bodyClass: 'true'
    },
    options = {
...
gulp.task('inject', function() {
  return gulp.src(paths.src.html)
    .pipe(gulpif(bs, inject(gulp.src([paths.src.root + paths.dist.css + '/bootstrap*.css'], {
      read: false
    }), {
      name: 'bs',
      relative: true,
    ...
    .pipe(gulpif(uk, inject(gulp.src([paths.src.root + paths.dist.css + '/uikit*.css'], {
      read: false
    }), {
      name: 'uk',
      relative: true,
    ...
    .pipe(gulpif(tw, inject(gulp.src([paths.src.root + paths.dist.css + '/tailwind*.css'], {
      read: false
    }), {
      name: 'tw',
      relative: true,
    ...
    .pipe(gulpif(fa, inject(gulp.src([paths.src.root + paths.dist.css + '/font*.css'], {
      read: false
    }), {
      name: 'fa',
      relative: true,
    ...
    .pipe(inject(gulp.src([paths.src.root + paths.dist.css + '/colors-nthu.css'], {allowEmpty: true}, {
      read: false
    }), {
      name: 'nthu',
      relative: true,
    ...
    .pipe(gulpif(uk, inject(gulp.src([paths.src.root + paths.dist.js + '/uikit.min.js'], {
      read: false
    }), {
      name: 'uk',
      relative: true,
    ...
    .pipe(gulpif(uk, inject(gulp.src([paths.src.root + paths.dist.js + '/uikit-icons.min.js'], {
      read: false
    }), {
      name: 'uk2',
      relative: true,
    ...
    //   }
    // }))
    .pipe(gulpif(bs, inject(gulp.src([paths.src.root + paths.dist.js + '/bootstrap*.js'], {
      read: false
    }), {
      name: 'bs',
      relative: true,
...
gulp.task('build-inject', function() {
  return gulp.src(paths.dist.html)
    .pipe(gulpif(bs, inject(gulp.src([paths.dist.root + paths.dist.css + '/bootstrap*.css'], {
      read: false
    }), {
      name: 'bs',
      relative: true,
    ...
    .pipe(gulpif(uk, inject(gulp.src([paths.dist.root + paths.dist.css + '/uikit*.css'], {
      read: false
    }), {
      name: 'uk',
      relative: true,
    ...
    .pipe(gulpif(tw, inject(gulp.src([paths.dist.root + paths.dist.css + '/tailwind*.css'], {
      read: false
    }), {
      name: 'tw',
      relative: true,
    ...
    .pipe(gulpif(fa, inject(gulp.src([paths.dist.root + paths.dist.css + '/font*.css'], {
      read: false
    }), {
      name: 'fa',
      relative: true,
    ...
    .pipe(inject(gulp.src([paths.dist.root + paths.dist.css + '/colors-nthu*.css'], {allowEmpty: true}, {
      read: false
    }), {
      name: 'nthu',
      relative: true,
    ...
    .pipe(gulpif(uk, inject(gulp.src([paths.dist.root + paths.dist.js + '/uikit.min.js'], {
      read: false
    }), {
      name: 'uk',
      relative: true,
    ...
    .pipe(gulpif(uk, inject(gulp.src([paths.dist.root + paths.dist.js + '/uikit-icons.min.js'], {
      read: false
    }), {
      name: 'uk2',
      relative: true,
    ...
    //   }
    // }))
    .pipe(gulpif(bs, inject(gulp.src([paths.dist.root + paths.dist.js + '/bootstrap*.js'], {
      read: false
    }), {
      name: 'bs',
      relative: true,
...
gulp.task('sass', function() {
  return gulp.src([paths.src.scss, '!' + paths.src.root + paths.dist.scss + '/*-i.scss', '!' + paths.src.root + paths.dist.scss + '/*-bak.scss'])
    ...
    // .pipe(del(paths.src.root + paths.dist.css, '!' + paths.vendors.keepcss))
...
gulp.task('vendors', gulp.series('ukjs', 'ukcss', 'bsscss', 'bscss', 'bsjs', 'bs3js', 'bs3css', 'bs3fonts', 'facss', 'fafonts', 'jqjs', 'keepcss'));
...
gulp.task('html', gulp.series('delhtml', 'templates', 'deletecss', 'deletejs', 'sass', 'js', 'inject'));

//0. Preset
gulp.task('start', gulp.series('deletecss', 'deletejs', 'vendors', 'delhtml', 'templates', 'sass', 'js', 'inject'));

//1. Preset then watch
gulp.task('server', gulp.series('deletecss', 'deletejs', 'vendors', 'tailwind', 'delhtml', 'templates', 'sass', 'inject', 'watch'));
...
gulp.task('build-purge', gulp.series('dist', 'clean', 'deletecss', 'deletejs', 'vendors', 'tailwind', 'tailwind-purge', 'delhtml', 'templates', 'js', 'tocss', 'img', 'inject', 'build-inject'));
gulp.task('build', gulp.series('dist', 'clean', 'deletecss', 'deletejs', 'vendors', 'tailwind-build', 'delhtml', 'templates', 'js', 'tocss', 'img', 'inject', 'build-inject'));
